package com.ellis.common.service.page;
...
public class PageData<T> implements Serializable
{
    ...
    public String toString()
    {
        return String.format(
                "PageData [pageData=%s, pageNo=%s, pageSize=%s, dataTotal=%s, pageTotal=%s, prevPage=%s, nextPage=%s, nextCursor=%s]",
                JSON.toJSONString(pageData.toArray()), pageNo, pageSize, dataTotal, pageTotal, prevPage, nextPage,
                nextCursor);
    }
